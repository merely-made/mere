...
//!   never sees a window.
//!
//! The three composited layers (per the §6 plan): the [`crate::canvas::underlay`]
...
/// Build the seiche [`AffinitySpring`] from a cartography [`AffinityScores`](crate::signals::AffinityScores)
...
fn build_affinity_spring(scores: &crate::signals::AffinityScores) -> AffinitySpring {
...
fn blend_affinity_pairs(
    structural: Option<&crate::signals::AffinityScores>,
...
/// re-exported so `crate::canvas::TICK_DT` keeps resolving canvas-wide.
...
pub struct Canvas {
    ...
    gloss_overlays: Vec<crate::signals::Overlay>,
