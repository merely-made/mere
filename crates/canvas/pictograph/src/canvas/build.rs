...
//! Construction + small paint/DOM helpers for the [`Canvas`](crate::canvas::Canvas): the
...
/// custom properties from [`crate::canvas::palette`], and the classes below `var()` them,
...
/// [`build_simulation`] at startup and [`Canvas::visit`](crate::canvas::Canvas::visit)
