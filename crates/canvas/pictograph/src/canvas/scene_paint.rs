...
//! (see [`crate::canvas::cartography_scene`]); this turns that projection into the
...
impl CanvasPaintList {
    ...
    /// insert. Used by the visual-coupling pass ([`crate::canvas::coupling_paint`]).
...
/// [`crate::canvas::canvas::canvas_paint_list_demoted`].
