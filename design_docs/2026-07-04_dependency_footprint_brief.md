...
bumped `components/fonts` *(historical citation)* <!-- doc-audit: historical-path --> and `components/malloc_size_of` *(historical citation)* <!-- doc-audit: historical-path --> (the two direct
